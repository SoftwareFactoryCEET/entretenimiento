...
namespace Entretenimiento.WebApplication.Controllers
{
    public class SeriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("NumberOfEpisodes,Id,Name,Release")] Series series)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("NumberOfEpisodes,Id,Name,Release")] Series series)
        {
            if (id != series.Id)
            {
                return NotFound();
